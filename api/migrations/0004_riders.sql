-- Step 5 of §17: versioned tech riders, press kit, social accounts.
...
CREATE TABLE tech_riders (
    ...
    -- structured sections: identity, stage line-up, stage plot, input list,
    -- backline, sound, light, dressing rooms, arrival, technical contacts (§12)
...
-- The event points at the version actually sent to the venue.
...
-- The app records who has access, never the passwords (§11.3).
...
-- "Who can publish on this account?" — the one question that blocks on the day.
